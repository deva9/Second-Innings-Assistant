 ...
 */
public class DatabaseHelperAft extends SQLiteOpenHelper {


    public static final String DATABASE_NAME = "Selfaft.db";
    public static final String TABLE_NAME = "self_tableaft";
    public static final String COL_1 = "ID";
    public static final String COL_2 = "NAME";
    public static final String COL_3 = "NO";
    //public static final String COL_4 = "USERPASS";

    public DatabaseHelperAft(Context context) {
